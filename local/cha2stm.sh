...
if [ -d zulu8.17.0.3-jdk8.0.102-linux_x64 ]; then
  ...
  wget http://cdn.azul.com/zulu/bin/zulu8.17.0.3-jdk8.0.102-linux_x64.tar.gz || exit 1
  tar -zxvf zulu8.17.0.3-jdk8.0.102-linux_x64.tar.gz
  rm zulu8.17.0.3-jdk8.0.102-linux_x64.tar.gz
