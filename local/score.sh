...
$cmd LMWT=$min_acwt:$max_acwt $dir/scoring/log/best_path.LMWT.log \
...
if $reverse; then
  for lmwt in `seq $min_acwt $max_acwt`; do
...
$cmd LMWT=$min_acwt:$max_acwt $dir/scoring/log/score.LMWT.log \
